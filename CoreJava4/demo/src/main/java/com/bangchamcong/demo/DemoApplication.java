...
public class DemoApplication {
    ...
    public static void main(String[] args) {
        ...
        try (FileInputStream fis = new FileInputStream(new File(filePath));
            ...
            System.out.println("Wage Type Fully Declared: " + wageTypeFullyDeclared(sheet));
            displayEmployeeHourTable(sheet);


            DailyIncomePerPerson income = new DailyIncomePerPerson(sheet);
            TablePrinter.printTable(income.getSumDailyPerEmployee(sheet,18));
            TablePrinter.printIncomeMap(income.incomeOfMonth(sheet, income.getSumDailyPerEmployee(sheet,18),16));
    ...
    private static Map<String,Integer> hourSum(Map<String, Map<Integer,Integer>> map){
        String name = "";
        int sum = 0;
    ...
    public static void displayEmployeeHourTable(Sheet sheet) {
        int pointer = -1;
