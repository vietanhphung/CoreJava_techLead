...
import com.bangchamcong.demo.DemoApplication;
...
public class DailyIncomePerPerson {

    Sheet sheet;

    public DailyIncomePerPerson(Sheet sheet){
        this.sheet = sheet;
    }
    ...
    public Map<String, Map<Integer,Double>> getSumDailyPerEmployee(Sheet sheet, int startPointer){
        ...
        Map<Integer, int[]> mergedRegions = DemoApplication.getMergedRegionsForRow(sheet, 3);
